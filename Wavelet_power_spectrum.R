...
# Load your data
my.data <- read.csv("combined_data.csv")
...
# Plotting with logarithmic x-axis and adding a legend
library(ggplot2)

# Assuming your data frame and significant data have already been prepared
# Plotting
# Plotting
ggplot() +
...
wt.avg(result, siglvl = 0.05, sigcol = "red",
       periodlab = "Periods (years)",
       main = "Global wavelet spectrum with 5% signifiance level of #41049")

period_max = 1.29062681
period_min = 0.74127045
